...
export const MethodsList = ({ topicCoveredMethodsByTest, summary }: Props) => {
  ...
  const isShowSceleton = isProcessing || data.length === 0;
  const noMethodsFound = filteredData.length === 0 && !isProcessing && selectedMethodsCount > 0;
